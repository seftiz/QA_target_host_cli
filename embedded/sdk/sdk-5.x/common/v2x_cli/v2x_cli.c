...
//#ifdef __linux__
  ...
  c = cli_register_command(*cli, NULL, "register", NULL, PRIVILEGE_UNPRIVILEGED, MODE_ANY, "register remote device and service(s)");
  cli_register_command(*cli, c, "device", cli_device_register, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "register remote device [-hw_addr xx:xx:xx:xx:xx:xx] (MAC address)" );
  cli_register_command(*cli, c, "service", cli_service_register, PRIVILEGE_UNPRIVILEGED, MODE_EXEC, "register remote service [-service SERVICE] (V2X, ECC, etc...)");
//#endif
